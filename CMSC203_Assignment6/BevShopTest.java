...
public class BevShopTest {
    ...
    {
        bevShop.startNewOrder(8,DAY.MONDAY,"Kate", 20);
        bevShop.processCoffeeOrder("americano", SIZE.SMALL, true, false);//2.5
        bevShop.processCoffeeOrder("Cappuccino", SIZE.LARGE, false, false);//4.0
        bevShop.processCoffeeOrder("Latte", SIZE.LARGE,true, true);//5.0

        bevShop.startNewOrder(8,DAY.SUNDAY,"John", 30);
        bevShop.processSmoothieOrder("Detox", SIZE.SMALL, 1, false);//2.5
        bevShop.processAlcoholOrder("Mohito", SIZE.SMALL); //2.0 ****------------------------------------

        bevShop.startNewOrder(12,DAY.SATURDAY,"Amy", 43);
        bevShop.processSmoothieOrder("Detox", SIZE.MEDIUM, 4, true); //5.5
        bevShop.processCoffeeOrder("Latte", SIZE.SMALL,false, false); //2
